<?php
  ...
  $pageAuth = [
      "html" => ["main","editProfile"], 
      "webservice" => ["delete", "addBM", "logout", "getBM", "addCategory", "deleteCategory", "editBM", "editUserDB", "shareBookmark", "getSharedBookmarks", "deleteSharedBookmarks", "addBmToCategory"]
  ] ;
